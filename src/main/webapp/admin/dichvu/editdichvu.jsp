            ...
            <div class="container mt-5">
                ...
                <form action="dichvu?action=update" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="maDichVu" name="maDichVu" value="${dichVu.maDichVu}"
                               readonly>
                    </div>
                    <div class="mb-3">
                        <label for="tenDichVu" class="form-label">Tên Dịch Vụ:</label>
                        <input type="text" class="form-control" id="tenDichVu" name="tenDichVu"
                               value="${dichVu.tenDichVu}" required>
                    </div>
                    <div class="mb-3">
                        <label for="giaTien" class="form-label">Giá Tiền:</label>
                        <input type="number" class="form-control" id="giaTien" name="giaTien" value="${dichVu.giaTien}"
                               required>
                    </div>

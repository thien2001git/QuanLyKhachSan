...
<div class="row mt-3">
    <a href="${pageContext.request.contextPath}/loaiphong"
       class="my-btn col-md-12 mb-3 btn bg-light btn-lg btn-block d-flex flex-row justify-content-start align-items-center">
        ...
        <span style="margin-left: 8px">Loại Phòng</span>
    </a>
    <a href="${pageContext.request.contextPath}/phong"
       class="my-btn col-md-12 mb-3 btn bg-light btn-lg btn-block d-flex flex-row justify-content-start align-items-center">
        ...
        <span style="margin-left: 8px">Phòng</span>
    </a>
    <a href="${pageContext.request.contextPath}/khachhang"
       class="my-btn col-md-12 mb-3 btn bg-light btn-lg btn-block d-flex flex-row justify-content-start align-items-center">
        ...
        <span style="margin-left: 8px">Khách Hàng</span>
    </a>
    <a href="${pageContext.request.contextPath}/hoadon"
       class="my-btn col-md-12 mb-3 btn bg-light btn-lg btn-block d-flex flex-row justify-content-start align-items-center">
        ...
        <span style="margin-left: 8px">Hóa Đơn</span>
    </a>
    <a href="${pageContext.request.contextPath}/dichvu"
       class="my-btn col-md-12 mb-3 btn bg-light btn-lg btn-block d-flex flex-row justify-content-start align-items-center">
        ...
        <span style="margin-left: 8px">Dịch Vụ</span>
    </a>
    <a href="${pageContext.request.contextPath}/chitietdichvu"
       class="my-btn col-md-12 mb-3 btn bg-light btn-lg btn-block d-flex flex-row justify-content-start align-items-center">
        ...
        <span style="margin-left: 8px">Chi Tiết Dịch Vụ</span>
    </a>
    <a href="${pageContext.request.contextPath}/phieuthuephong"
       class="my-btn col-md-12 mb-3 btn bg-light btn-lg btn-block d-flex flex-row justify-content-start align-items-center">
        ...
        <span style="margin-left: 8px">Thuê Phòng</span>
    </a>
</div>
